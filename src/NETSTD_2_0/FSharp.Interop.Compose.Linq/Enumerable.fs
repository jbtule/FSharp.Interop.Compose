...
module Enumerable =
    ...
    /// Calls [`Append(source, element)`](https://docs.microsoft.com/en-us/dotnet/api/system.linq.enumerable.append)
    let inline append element source = System.Linq.Enumerable.Append(source, element)
    ...
    /// Calls [`Prepend(source, element)`](https://docs.microsoft.com/en-us/dotnet/api/system.linq.enumerable.prepend)
    let inline prepend element source = System.Linq.Enumerable.Prepend(source, element)
