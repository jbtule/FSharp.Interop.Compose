...
module Enumerable =
    ...
    /// Calls [`Append(source, element)`](http://msdn.microsoft.com/en-us/library/system.linq.enumerable.append)
    ...
    /// Calls [`Prepend(source, element)`](http://msdn.microsoft.com/en-us/library/system.linq.enumerable.prepend)
