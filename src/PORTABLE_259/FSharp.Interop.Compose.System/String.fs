...
module String =
    ...
    module Full =
        ...
        /// Calls [`EndsWith(value, comparisonType)`](https://docs.microsoft.com/en-us/dotnet/api/system.string.endswith)
        ...
        /// Calls [`StartsWith(value, comparisonType)`](https://docs.microsoft.com/en-us/dotnet/api/system.string.startswith)
