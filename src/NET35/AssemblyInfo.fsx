...
[<assembly: AssemblyDescriptionAttribute("NET35: Inline composable fsharp functions around BCL static methods. Supports F# 3.0 and later with .NET runtimes v2.0,v4.0, Sliverlight 5.0 and WinRT")>]
